"""Analysis service for exam statistics"""
...
class ExamAnalysisService:
    ...
    def calculate_analysis(self, exam_id: str, grading_mode: str) -> Dict[str, Any]:
    ...
    def get_analysis(self, exam_id: str) -> Dict[str, Any]:
